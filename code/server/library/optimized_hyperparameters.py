...
class optimized_hyperparameters:
    ...
    def __find_best(__self):
        for i in np.arange(0,0.55,0.05):
            ...
            if __self.best_model==None:
                ...
                __self.best_hyperparameter_combination=i.get_best_params()
                __self.best_train_test_split=i.get_train_test_split()
            else:
    ...
    def to_json(__self):
        result={"results":__self.best_model.to_json(),"best_hyperparameters":__self.best_hyperparameter_combination,"best_train_test_split":__self.best_train_test_split}
